...
public class VoiceRecognitionRunnable implements RecognitionListener, Runnable {

    private final static String TAG = "VoiceRecognitionRunnable";

    private final Context context;
    private SpeechRecognizer speechRecognizer;

    public VoiceRecognitionRunnable(Context context) {
